...
FIRST = "func choose(_ a: Bool, _ b: Bool) -> Int {\n if a && b { return 1 }\n return 0\n}\n"
SECOND = "func decide(_ a: Bool, _ b: Bool) -> Int {\n if a && b { return 1 }\n return 0\n}\n"


def test_cross_file_duplicate_is_found(tmp_path: Path) -> None:
    (tmp_path / "a.swift").write_text(FIRST, encoding="utf-8")
    (tmp_path / "b.swift").write_text(SECOND, encoding="utf-8")
    assert find_duplicates(tmp_path, min_tokens=8)
